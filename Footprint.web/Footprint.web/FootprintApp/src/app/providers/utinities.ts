...
export class Utilities {
    ...
    public static readonly captionAndMessageSeparator = ":"; //标题和消息分隔符
    public static readonly noNetworkMessageCaption = "没有网络";//没有网络
    public static readonly noNetworkMessageDetail = "无法链接服务器";
