...
namespace FootPrint.Business
{
    ...
    public class AccountManager : IAccountManager
    {
        ...
        public async Task<Tuple<ApplicationUser, string[]>> GetUserAndRolesAsync(long userId)
        {
        ...
        public async Task<List<Tuple<ApplicationUser, string[]>>> GetUsersAndRolesAsync(int page, int pageSize,string order)
        {
            IQueryable<ApplicationUser> usersQuery = _context.Users
                .Include(u => u.Roles)
                .CustomOrderBy(order);
